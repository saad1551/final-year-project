...
Based on the agent's trajectory, refine the task, steps and criteria to raise the difficulty.
...
USER_PROMPT_TEMPLATE = """## Help Me Raise The Task Difficulty

You are viewing a summary of the agent's trajectory:
...
class TaskChallengerPrompt(BaseTaskProposerPrompt):
